...
function mapInitialize(){
    ...
    .then( data => {
        ...
        var map = new L.Map('map', {      center:[37.983810, 23.727539],       zoom: 2,         layers: [grayscale]  });
        ...
        .then( datas => {
            ...
            table.forEach(element => {
                ...
                //count normalization, beetween 0-1
                countIP = element['countResIP'] / datas[0]['res_ip_count'];

                var latlngs = [ [element['latitude'], element['longitude']],
                                [element['resLatitude'], element['resLongitude']] ];
                var polyline = L.polyline(latlngs, {color: 'red', weight: countIP });
                polyline.bindPopup(element['res_ip_count']).addTo(map);
