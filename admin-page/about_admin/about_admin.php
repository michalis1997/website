...
<body>
      ...
      <div class="collapse navbar-collapse" id="navbarCollapse">
        <ul class="navbar-nav ml-auto navbar-spacing mr-3" >
          ...
          <li class="nav-item active pl-2" >
            <a class="nav-link text-light" href="about_admin.php"><i class="fa fa-users" aria-hidden="true"></i> About</a>
          </li>
        </ul>
  ...
  <!-- header area -->
  <div class="about-section pb-5" style="background-color: #5D6D7E">
    <div class="mt-3 mb-3 pt-5 text-center text-light"> 
      <h1>About Us</h1>
    </div>
  </div>
  <!-- /header area -->
