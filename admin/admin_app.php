...
<body style="background-color: #D8E4EA">
  ...
  <div class="pt-5 pb-3">
    ...
    <div class="text-dark mb-5 board ml-3 mr-3" style="background-color: rgb(190, 219, 229); box-shadow: 0 20px 50px 0 rgb(78, 132, 164);"> 
        <div class="justify-content-md-center">
          ...
          <div class="ml-3 mr-3 row justify-content-md-center">
              ...
              <div class="col-md-3 col-sm-3 col-xs-3">
                  <button class="container mb-4 btn" onclick="showChart3()" id="chart3" style="background-color: rgb(35, 89, 116); color: white; text-align: center;">HTTP Headers - cache-control</button>
              </div>
              <div class="col-md-3 col-sm-3 col-xs-3">
    ...
    <div id="showChart2" class="container text-dark mb-5 board "style="display:none; width:100%; background-color: white; box-shadow: 0 20px 50px 0 rgb(78, 132, 164);">
      <div class="row justify-content-md-center">
          ...
          <div class="col-md-3 col-sm-3 col-xs-3 justify-content-center" >
            <button class="container mb-4 btn" onclick="showSubChart2a()" id="chart2a" style="background-color: rgb(35, 89, 116); color: white; text-align: center;">HTTP Object per Content Type</button>
          </div>
          <div class="col-md-3 col-sm-3 col-xs-3 justify-content-center" >
            <button class="container mb-4 btn" onclick="showSubChart2b()" id="chart2b" style="background-color: rgb(35, 89, 116); color: white; text-align: center;">Days of the Week </button>
          </div>
          <div class="col-md-3 col-sm-3 col-xs-3 justify-content-center" >
            <button class="container mb-4 btn" onclick="showSubChart2c()" id="chart2c" style="background-color: rgb(35, 89, 116); color: white; text-align: center;">Http Request Method</button>
          </div>
          <div class="col-md-3 col-sm-3 col-xs-3 justify-content-center" >
            <button class="container mb-4 btn" onclick="showSubChart2d()" id="chart2d" style="background-color: rgb(35, 89, 116); color: white; text-align: center;">ISP Provider Connectivity</button>
          </div>


          <div id="subChart2a" class="container" style="display:none;">
                <button id="toggle21">show/hide all</button> 
                <canvas id="sub2sub1chart" width="700" height="300"></canvas>  
          </div>


          <div id="subChart2b" class="container" style="display:none;">
              <canvas id="myChart" width="400" height="150"></canvas>
          </div>
          <div id="subChart2c" class="container" style="display:none;">
              <canvas id="myChart" width="400" height="150"></canvas>
          </div>
          <div id="subChart2d" class="container" style="display:none;">
              <canvas id="myChart" width="400" height="150"></canvas>
          </div>
    ...
    <div id="showChart3" class="container text-dark mb-5 board " style="display:none; width:100%; background-color: white; box-shadow: 0 20px 50px 0 rgb(78, 132, 164);">
      <div class="row justify-content-md-center">
        <h2 class="mb-5 card-header w-100 font-weight-light text-center " style="background-color: rgb(217, 237, 243);">
                  Analyze HTTP Headers - cache-control per Content Type</h2>
        
            <div class="col-md-4 col-sm-4 col-xs-4 justify-content-center" >
              <button class="container mb-4 btn" onclick="showSubChart3a()" id="chart3a" style="background-color: rgb(35, 89, 116); color: white; text-align: center;">Response TTL</button>
            </div>
            <div class="col-md-4 col-sm-4 col-xs-4 justify-content-center" >
              <button class="container mb-4 btn" onclick="showSubChart3b()" id="chart3b" style="background-color: rgb(35, 89, 116); color: white; text-align: center;">Max-stale, Min-fresh</button>
            </div>
            <div class="col-md-4 col-sm-4 col-xs-4 justify-content-center" >
              <button class="container mb-4 btn" onclick="showSubChart3c()" id="chart3c" style="background-color: rgb(35, 89, 116); color: white; text-align: center;">Response Cacheability Percentage</button>
            </div>
            
            <div id="subChart3a" class="container" style="display:none;">
                <canvas id="myChart" width="400" height="150"></canvas>
            </div>

            <div id="subChart3b" class="container" style="display:none;">
                <canvas id="myChart" width="400" height="150"></canvas>
            </div>

            <div id="subChart3c" class="container" style="display:none;">
                  <canvas id="myChart" width="400" height="150"></canvas>
            </div>
      </div>
    </div>
        ...
        <div class="row justify-content-md-center">
          ...
          <div  class="container mb-3" >
            ...
            <h3 id="wait" class="text-center font-weight-light text-center">
              Please wait, this may take a few seconds to load
            </h3>
  ...
  <script src="chart3/chart3.js"></script>
